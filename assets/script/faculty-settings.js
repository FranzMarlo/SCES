document.addEventListener("DOMContentLoaded", function () {
    document.getElementById("edit-profile-info").onclick = function () {
      document.getElementById("facultyEditProfileModal").style.display = "flex";
    };
  
    document.getElementById("closeModal").onclick = function () {
      const form = document.getElementById("facultyEditProfileForm");
      document.getElementById("facultyEditProfileModal").style.display = "none";
      form.reset();
    };
  
    const editPersonalModal = document.getElementById("facultyEditPersonalModal");
    ...
    function resetForm() {
      const form = document.getElementById("facultyEditBackgroundForm");
      const city = document.getElementById("city");
      const barangay = document.getElementById("barangay");
    ...
    document
      ...
      .addEventListener("click", () => {
        document.getElementById("facultyChangeAvatarModal").style.display = "block";
      });
  
    document.getElementById("closeAvatarModal").addEventListener("click", () => {
      document.getElementById("facultyChangeAvatarModal").style.display = "none";
    });
  
    const modal = document.getElementById("facultyPasswordModal");
    const changePasswordBtn = document.getElementById("changePassword");
    const closeBtn = document.getElementById("closePasswordModal");
    const updatePasswordForm = document.getElementById("facultyUpdatePassword");
