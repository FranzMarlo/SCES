...
$subject = $db->getSubjectDetails('ESP 1', $sectionId, $level_id);
?>
<link rel="stylesheet" href="/SCES/assets/style/lessons.css" />
<title>ESP | SCES Online Learning Platform</title>
</head>
      ...
      <div class="lesson-panel">
        ...
        <div class="lesson-container">
          <div class="lesson-header">
            <div class="header-bg esp">
              <div class="icon-container">
                <img src="/SCES/assets/images/<?php echo htmlspecialchars($subject['icon']); ?>" alt="esp-icon">
              </div>
            </div>
          ...
          <div class="lesson-content">
            ...
            <div class="lesson-box">
              <div class="lesson-item esp-item">
