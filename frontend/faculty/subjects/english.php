      ...
      <div class="lesson-panel">
        ...
        <div class="lesson-container">
          <div class="tab-controller">
            <div class="tab eng" id="lessonTab">Lessons</div>
            <div class="tab eng" id="studentTab">Students</div>
            <div class="tab eng" id="recordsTab">Records</div>
            <div class="tab eng" id="analyticsTab">Analytics</div>
          </div>
