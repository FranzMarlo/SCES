      ...
      <div class="lesson-panel">
        ...
        <div class="lesson-container">
          <div class="tab-controller">
            <div class="tab ap" id="lessonTab">Lessons</div>
            <div class="tab ap" id="studentTab">Students</div>
            <div class="tab ap" id="recordsTab">Records</div>
            <div class="tab ap" id="analyticsTab">Analytics</div>
          </div>
